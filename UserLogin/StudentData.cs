...

{
    public class StudentData
    {
        ...
        { get; private set; } = new List<Student> { new Student("Denislav", "Biserov", "Petkov", "FKST","KSI", "Bachelor",  "passed", "121219099", 6, 9, 31),
                                                    new Student("Pavel", "Biserov", "Petkov", "FKST","KSI", "Masters", "passed", "121213100", 4, 12, 31),
